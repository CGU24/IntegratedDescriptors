...
label_train = pd.read_csv(os.path.join(current_dir, 'butane_train.csv'), header=0, low_memory=False)
descriptor_train = pd.read_csv(os.path.join(current_dir, 'train_list.csv'), header=0, low_memory=False)
label_train_add = pd.read_csv(os.path.join(current_dir, 'butane_train_add.csv'), header=0, low_memory=False)
